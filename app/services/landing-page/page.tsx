...
const BRAND_GRADIENT =
    "linear-gradient(87.22deg, rgb(255, 138, 76) -1.82%, rgb(255, 60, 172) 50.47%, rgb(103, 33, 255) 113.5%)";

const PAIN_POINTS = [
    {
        title: "Burning Ad Spend",
        desc: "Sending paid traffic to a generic homepage is setting money on fire.",
        icon: DollarSign,
        color: "text-red-400",
    },
    {
        title: "Low Conversion Rates",
        desc: "Industry average is 2.35%. If you aren't hitting 5%+, your funnel is leaking.",
        icon: Percent,
        color: "text-orange-400",
    },
    {
        title: "Confusing Offer",
        desc: "If visitors don't understand what you do in 5 seconds, they leave.",
        icon: AlertTriangle,
        color: "text-yellow-400",
    },
    {
        title: "Slow Load Times",
        desc: "Every second delay reduces conversions by 7%. Speed is revenue.",
        icon: Timer,
        color: "text-rose-400",
    },
];
...
const PROCESS_STEPS = [
    { title: "Research", desc: "Competitor & Market Analysis" },
    { title: "Strategy", desc: "Offer & Hook Development" },
    { title: "Copywriting", desc: "Persuasion Frameworks" },
    { title: "Design", desc: "UX & Visual Architecture" },
    { title: "Optimization", desc: "A/B Testing & Iteration" },
];

const SERVICES_DATA = [
    {
        id: "cro-design",
        category: "01. PSYCHOLOGY",
        title: "Conversion-Focused Design",
        description:
            "Design that doesn't just look good—it works. We use eye-tracking patterns and cognitive biases to guide visitors inevitably toward the 'Buy' button.",
        icon: LayoutTemplate,
        outcome: "Higher Click-Through",
        stack: ["Figma", "Heatmaps", "UserTesting"],
        checklist: [
    ...
    {
        id: "copywriting",
        category: "02. PERSUASION",
        title: "Direct Response Copywriting",
        description:
            "Words that sell. We craft compelling headlines, hooks, and body copy that address objections and trigger deep emotional desires.",
        icon: PenTool,
        outcome: "Higher Conv. Rate",
        stack: ["StoryBrand", "PAS Framework", "AIDA"],
        checklist: [
    ...
    },
    {
        ...
        description:
            "We don't guess. We test. systematically pitting variations against each other to scientifically prove what generates the most revenue.",
        icon: Split,
        outcome: "Data-Driven Growth",
        stack: ["VWO", "Google Optimize", "Hotjar"],
        checklist: [
    ...
    },
    {
        ...
        description:
            "Landing pages that load instantly. We build lightweight, code-optimized pages that maximize quality score and minimize bounce rates.",
        icon: Zap,
        outcome: "< 500ms Load Time",
        ...
        >
            ...
            <section className="relative pt-32 pb-20 px-6 min-h-[60vh] flex flex-col justify-center items-center text-center">
                <div className="max-w-4xl mx-auto z-10">
                    ...
                    <p className="hero-element text-lg md:text-2xl text-[#888] max-w-2xl mx-auto font-light leading-relaxed">
                        {`Traffic is meaningless without action. We build high-velocity landing pages scientifically designed to convert.`}
                    </p>
                </div>
            </section>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div>
                            <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-4">
                                Leaking <span className="text-red-500">Revenue</span>
                            </h2>
                            <p className="text-gray-500 max-w-md">
                                Stop paying for traffic that bounces. Fix your funnel.
                            </p>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-20 space-y-40">
                {SERVICES_DATA.map((service, index) => (
                    <div
                        key={service.id}
                        className={`service-row flex flex-col lg:flex-row gap-12 lg:gap-20 items-stretch ${index % 2 !== 0 ? "lg:flex-row-reverse" : ""
                            }`}
                    >
                        {/* Text / Spec Sheet */}
                            ...
                            <TiltCard intensity={15} className="h-full">
                                <div className="w-full h-full rounded-2xl border border-white/10 bg-[#0c0c0c] relative overflow-hidden group">
                                    ...
                                    <div className="absolute top-6 right-6">
                                        <Target className="text-orange-400 w-5 h-5 opacity-50" />
                                    </div>
                                    <div className="absolute bottom-6 left-6 font-mono text-[10px] text-gray-600">
                                        ID: {service.id.toUpperCase()}_CRO_01
                                    </div>
                                </div>
                            </TiltCard>
                        </div>
            ...
            <section className="relative py-40 px-6 text-center">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <p className="text-xl text-gray-400 mb-12 font-light">
                        Don't let good traffic go to waste. Build a machine that converts.
                    </p>
                    <Link href="/contact">
                        <Button
                            size="lg"
